...
namespace primal::script {
	namespace {
		...
		script_registery&
			registery() {
			// NOTE: we put this static variable in a function because of the initialization order of static data. This way, we can be certain that the data is initialized before accessing it.
