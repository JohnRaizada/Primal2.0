...
namespace primal::graphics::d3d12::shaders {
	namespace {
		...
		// This is a chunk of memory that contains all compiled engine shaders. The blob is an array of shader byte code consisting of a u64 size and an array of bytes.
