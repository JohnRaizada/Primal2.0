...
{
	// A vector class similar to std::vector with basic funtionality. The user can specify in the template argument whether they want elements' destructor to be called when being removed or while clearing/destructing the vector.
	...
	public:
		...
		// Clears the vector and destructs itms as specified in template argument.
		...
		// Returns a reference to the last item. Will fault the application if called when the vector is empty.
