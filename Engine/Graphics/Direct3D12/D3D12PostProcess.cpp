...
namespace primal::graphics::d3d12::fx
{
	...
	void
		...
		// NOTE: we don't nned to clear the render target, because each pixel will be overwritten by pixels from gpass main buffer. We also don't need a depth buffer.
