...
namespace PrimalEditor.Utilities
{
    ...
    internal static class Logger
    {
        ...
        public static async void Log(MessageType type, string msg, [CallerFilePath] string file = "", [CallerMemberName] string caller = "", [CallerLineNumber] int line = 0) => await Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                                                                                                                                                                                          {
        ...
        static Logger() => FilteredMessages.Filter += (s, e) =>
                                    {
